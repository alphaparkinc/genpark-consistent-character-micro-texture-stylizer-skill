# genpark-consistent-character-micro-texture-stylizer-skill
...
> **GenPark AI Agent Skill** -- Consistent character visual identity and micro-texture stylizer (Midjourney style)
